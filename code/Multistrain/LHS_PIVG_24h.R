...
# LHS scan - Infected model - 24 hour latent period

L1 = 24 # latent period (hours)
...
dev.copy2eps(file=paste("../../figures/densityPIVG_24h_24h",".eps",sep=""))
dev.copy2pdf(file=paste("../../figures/densityPIVG_24h_24h",".pdf",sep=""))
dev.copy(jpeg,file=paste("../../figures/densityPIVG_24h_24h",".jpg",sep=""))
dev.off()
dev.off()
...
dev.copy2eps(file=paste("../../figures/densityPIVG_24h_2h",".eps",sep=""))
dev.copy2pdf(file=paste("../../figures/densityPIVG_24h_2h",".pdf",sep=""))
dev.copy(jpeg,file=paste("../../figures/densityPIVG_24h_2h",".jpg",sep=""))
dev.off()
dev.off()
...
dev.copy2eps(file=paste("../../figures/densityPIVG_24h_both",".eps",sep=""))
dev.copy2pdf(file=paste("../../figures/densityPIVG_24h_both",".pdf",sep=""))
dev.copy(jpeg,file=paste("../../figures/densityPIVG_24h_both",".jpg",sep=""))
dev.off()
dev.off()
