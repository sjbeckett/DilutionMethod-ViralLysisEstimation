...
L1 = 0.25 # latent period (time between infection and lysis) [hours]
...
dev.copy2eps(file=paste("../../figures/scanPIVG_15min_24h",".eps",sep=""))
dev.copy2pdf(file=paste("../../figures/scanPIVG_15min_24h",".pdf",sep=""))
dev.copy(jpeg,file=paste("../../figures/scanPIVG_15min_24h",".jpg",sep=""))
dev.off()
dev.off()
...
dev.copy2eps(file=paste("../../figures/scanPIVG_15min_2h",".eps",sep=""))
dev.copy2pdf(file=paste("../../figures/scanPIVG_15min_2h",".pdf",sep=""))
dev.copy(jpeg,file=paste("../../figures/scanPIVG_15min_2h",".jpg",sep=""))
dev.off()
dev.off()
